---
title: "11.Why 1 + 1 < 1 in Visual Token Pruning: Beyond Naïve Integration via Multi-Objective Balanced Covering"
...
citation: '<br/><div style="text-align: justify;">Why 1+ 1< 1 in Visual Token Pruning: Beyond Naive Integration via Multi-Objective Balanced Covering, Y.-F. Li, H.-J. Zhan*, T.-Y. Chen, Y.-J. Xiong, Q. L, Y. L, Advances in Neural Information Processing Systems, 2025(accepted)</div>'
---
